...
function AddAutorForm() {
    return (
        <form action="/save-author" method="post" className="p-4 rounded-lg bg-white shadow ring-1 ring-inset ring-secondary">
            <div className="space-y-3">
                <div className="border-bottom border-3 pb-3">
                    <h2 className="h3 font-weight-bold text-dark">Añadir Autor</h2>
